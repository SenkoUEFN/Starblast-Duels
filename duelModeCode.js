 ...
 */
const HAS_BROWSER_DOM = typeof window !== "undefined" && typeof document !== "undefined";
const HAS_LOCAL_STORAGE = typeof localStorage !== "undefined";

startMapOpenWhenAddressReady();
...
this.options = {
    ...
    custom_map: "",
    map_name: "Starblast Duels",
};

if (HAS_BROWSER_DOM && typeof window.onerror !== "function" && staticMemory._GLOBAL_ERROR_HANDLER) {
...
async function startMapOpenWhenAddressReady() {
    while (
        typeof game === "undefined" ||
        !game ||
        !game.modding ||
        !game.modding.address
    ) {
